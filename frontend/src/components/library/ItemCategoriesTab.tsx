            ...
            <div className="p-6">
              ...
              <div className="flex justify-end gap-4 mt-6">
                ...
                {editingCategory ? (
                  <button
                    onClick={handleSave}
                    disabled={saving || !categoryForm.productCategoryId || categoryForm.productCategoryId === 0 || !categoryForm.name || categoryForm.name.trim() === ''}
                  ...
                  <button
                    ...
                    disabled={saving || !categoryForm.productCategoryId || categoryForm.productCategoryId === 0 || multipleCategories.filter(i => i.name.trim()).length === 0}
                    className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
